...
const alphaOrder = inventory.sort((a, b) => a.car_model.toLocaleLowerCase() > b.car_model.toLocaleLowerCase() ? 1 : -1)
...
for (let i = 0; i < inventory.length; i++) {
    inventory[i].car_make === 'BMW' || inventory[i].car_make === 'Audi' ? BMWAndAudi.push(inventory[i]) : null
}
